    ...
    <section className="relative h-[80vh] flex items-center justify-center overflow-hidden bg-[#141414]">
      <div className="relative z-10 max-w-2xl text-center px-4">
        ...
        <Link href="/recipes" className="inline-block">
          <button className="px-6 py-3 mt-8 bg-red-600 rounded-lg font-semibold hover:bg-red-700 hover:scale-105 hover:shadow-2xl transition-transform duration-300 flex items-center justify-center mx-auto text-black">
            Explore Recipes
