  ...
  },
{
    ...
    recipes: [
      ...
      },
      {
        ...
        instructions: "Cook the kidney beans first, add coconut milk, then add the washed rice and cook low heat. Add more coconut milk if the rice is still hard after the milk has soaked up",
      },
      {
        ...
        instructions: "Cook the stew first, add water, then add the washed rice and cook low heat. Add more water if the rice is still hard after the water has soaked up",
      },
      {
      ...
      {
        title: "Carrot Jollof Rice with Goat Meat",
        image: "/photos/rice7.jpeg",
        ingredients: ["Onions", "Carrots", "Bell peppers", "Long grain white rice", "Tomatoes", "Seasoning", "San Marcos chipotle sauce/salsa", "San Marcos chipotle peppers in adobe sauce", "Scotch bonnet"],
        instructions: "Cook the stew first, add water, then add the washed rice and cook low heat. Add more water if the rice is still hard after the water has soaked up. Steam then boil the goat meat with seasoning and then add to the stew",
      },
    ],
  },
  {
